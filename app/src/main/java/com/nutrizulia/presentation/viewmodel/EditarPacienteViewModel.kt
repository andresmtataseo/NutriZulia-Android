...
import com.nutrizulia.domain.usecase.collection.UpdatePaciente
    ...
    fun actualizarPaciente(paciente: Paciente) {
        ...
        viewModelScope.launch {
            ...
            try {
                ...
                _mensaje.postValue("Ocurrió un error inesperado al actulizar el paciente: ${e.message}")
                _salir.postValue(false)
                Log.e("RegistrarPacienteViewModel", "Error al actulizar paciente", e)
            }
